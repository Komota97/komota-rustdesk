...
# Windows
# NOTE (Komota overlay): the upstream Windows branch (MSYS2 bash.exe) only works
# when actually running on a Windows host. When cross-compiling to a mingw
# triplet from a Linux host, CMAKE_CURRENT_LIST_DIR is already Unix-style and
# that branch breaks -- fall through to the plain `make` branch instead (the
# Makefile only copies headers and generates a .pc file, so it's fine for
# producing the mingw-triplet package too). On a native Windows host, always
# use the original MSYS branch.
if(CMAKE_HOST_WIN32)
